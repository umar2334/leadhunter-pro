              ...
              <td className="px-4 py-3">
                ...
                {lead.website && (
                  <a href={lead.website} target="_blank" rel="noopener noreferrer"
                    className="text-xs text-slate-500 hover:text-indigo-400 flex items-center gap-1 mt-0.5 max-w-[120px] truncate">
                    <Globe className="w-3 h-3 flex-shrink-0" />
                    {lead.website.replace(/^https?:\/\//, '').slice(0, 25)}
                  </a>
                )}
                {!lead.phone && !lead.website && <span className="text-slate-700 text-xs">—</span>}
              </td>
                    ...
                    <div className="w-16 h-1.5 bg-[#2d2d3d] rounded-full">
                      <div
                        ...
                        style={{
                          ...
                          background: lead.analysis_score < 40 ? '#ef4444'
